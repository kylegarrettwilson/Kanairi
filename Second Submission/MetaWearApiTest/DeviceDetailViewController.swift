...
class DeviceDetailViewController: StaticDataTableViewController, DFUServiceDelegate, DFUProgressDelegate, CLLocationManagerDelegate, LoggerDelegate, DFUPeripheralSelectorDelegate {
    ...
    @IBAction func accelerometerBMI160StartStreamPressed(_ sender: Any) {
        ...
        accelerometerBMI160StartStream.alpha = 0.2
        accelerometerBMI160StopStream.alpha = 1
        ...
        self.streamingEvents.insert(self.device.accelerometer!.dataReadyEvent)
        self.device.accelerometer!.dataReadyEvent.startNotificationsAsync { (obj, error) in
            if let obj = obj {
                ...
                if obj.x > 7 && myData.acceleration.x > 4{
                    ...
                    self.accelerometerBMI160StopStream.alpha = 0.2
                ...
                if obj.y > 7 && myData.acceleration.y > 4{
                ...
                if obj.z > 7 && myData.acceleration.z > 4{
    ...
    @IBAction func accelerometerBMI160StopStreamPressed(_ sender: Any) {
        ...
        accelerometerBMI160StartStream.alpha = 1
        accelerometerBMI160StopStream.alpha = 0.2
    }
